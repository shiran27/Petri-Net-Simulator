function [name,places,transitions,arcs,sizeOfSpace,specification,regions] = examplePNAGVClosedLoop()
    ...
    ZCS1 = Place(65, 'ZCS1', [150,430], [NaN,NaN], holdingTime);  %% Newline
    ZCS2 = Place(66, 'ZCS2', [150,330], [NaN,NaN], holdingTime);  %% Newline
    ZCS3 = Place(67, 'ZCS3', [150,240], [NaN,NaN], holdingTime);  %% Newline
    ZCS4 = Place(67, 'ZCS4', [150,140], [NaN,NaN], holdingTime);  %% Newline
    ...
    IPS8.addAToken(Token(3, 'AGV1', IPS8));
    
    CPS1.addAToken(Token(4, 'AGV5', CPS1));
    ...
    Z2S2.addAToken(Token(10, 'AGV3', Z2S2));
    
    WZS4.addAToken(Token(11, 'AGV4', WZS4));
    WZS12.addAToken(Token(12, 'AGV2', WZS12));
    
    ZCS1.addAToken(Token(13, 'ZCT1', ZCS1));
    ZCS3.addAToken(Token(14, 'ZCT3', ZCS3));
    ZCS4.addAToken(Token(15, 'ZCT4', ZCS4));
    ...
    places = [IPS1,IPS2,IPS3,IPS4,IPS5,IPS6,IPS7,IPS8,CPS1,CPS2,CPS3,CPS4,...
        ...
        WZS11,WZS12,WZS13,WZS14,WZS15,WZS16,WZS17,WZS18,WZS19,WZS20,WZS21,WZS22,ZCS1,ZCS2,ZCS3,ZCS4]; 
    ...
    W1T1 = Transition(13,'W1T1', [60, 340, 0], [NaN, NaN], transitTime);
    ...
    ZCA1 = Arc(129, 0, {IPT7,ZCS1},1);
    ZCA2 = Arc(130, 1, {ZCS1,IPT6},1);
    ZCA3 = Arc(131, 0, {IPT5,ZCS1},1);
    ZCA4 = Arc(132, 1, {ZCS1,IPT4},1);
    ZCA5 = Arc(133, 0, {WZT17,ZCS1},1);
    ZCA6 = Arc(134, 1, {ZCS1,WZT20},1);
    ZCA7 = Arc(135, 0, {WZT15,ZCS1},1);
    ZCA8 = Arc(136, 1, {ZCS1,WZT16},1);
    
    ZCA9  = Arc(137, 0, {WZT1,ZCS2},1);
    ZCA10 = Arc(138, 1, {ZCS2,WZT2},1);
    ZCA11 = Arc(139, 0, {WZT21,ZCS2},1);
    ZCA12 = Arc(140, 1, {ZCS2,WZT24},1);
    ZCA13 = Arc(141, 0, {WZT13,ZCS2},1);
    ZCA14 = Arc(142, 1, {ZCS2,WZT14},1);
    ZCA15 = Arc(143, 0, {WZT19,ZCS2},1);
    ZCA16 = Arc(144, 1, {ZCS2,WZT18},1);
    
    ZCA17 = Arc(145, 0, {WZT3,ZCS3},1);
    ZCA18 = Arc(146, 1, {ZCS3,WZT4},1);
    ZCA19 = Arc(147, 0, {WZT25,ZCS3},1);
    ZCA20 = Arc(148, 1, {ZCS3,WZT28},1);
    ZCA21 = Arc(149, 0, {WZT11,ZCS3},1);
    ZCA22 = Arc(150, 1, {ZCS3,WZT12},1);
    ZCA23 = Arc(151, 0, {WZT23,ZCS3},1);
    ZCA24 = Arc(152, 1, {ZCS3,WZT22},1);
    
    ZCA25 = Arc(153, 0, {WZT5,ZCS4},1);
    ZCA26 = Arc(154, 1, {ZCS4,WZT6},1);
    ZCA27 = Arc(155, 0, {WZT7,ZCS4},1);
    ZCA28 = Arc(156, 1, {ZCS4,WZT8},1);
    ZCA29 = Arc(157, 0, {WZT9,ZCS4},1);
    ZCA30 = Arc(158, 1, {ZCS4,WZT10},1);
    ZCA31 = Arc(159, 0, {WZT27,ZCS4},1);
    ZCA32 = Arc(160, 1, {ZCS4,WZT26},1);
    ...
    arcs = [IPA1,IPA2,IPA3,IPA4,IPA5,IPA6,IPA7,IPA8,IPA9,IPA10,...
        ...
        ZCA1,ZCA2,ZCA3,ZCA4,ZCA5,ZCA6,ZCA7,ZCA8,ZCA9,ZCA10,...
        ZCA11,ZCA12,ZCA13,ZCA14,ZCA15,ZCA16,ZCA17,ZCA18,ZCA19,ZCA20,...
        ZCA21,ZCA22,ZCA23,ZCA24,ZCA25,ZCA26,ZCA27,ZCA28,ZCA29,ZCA30,ZCA31,ZCA32]; 
    ...
    R11 = Region(11,'',true,[128,133,44,14],[0.5,0.5,0,0.1],lineWidth,edgeColor,[135,170],fontSize,fontColor);
    R12 = Region(12,'',true,[128,233,44,14],[0.5,0.5,0,0.1],lineWidth,edgeColor,[135,170],fontSize,fontColor);
    R13 = Region(13,'',true,[128,323,44,14],[0.5,0.5,0,0.1],lineWidth,edgeColor,[135,170],fontSize,fontColor);
    R14 = Region(14,'',true,[128,423,44,14],[0.5,0.5,0,0.1],lineWidth,edgeColor,[135,170],fontSize,fontColor);
    R15 = Region(14,'Zone Controllers:',true,[90,22,44,14],[0.5,0.5,0,0.1],lineWidth,edgeColor,[10,30],10,'k');
    
    regions = [R1,R2,R3,R4,R5,R6,R7,R8,R9,R10,R11,R12,R13,R14,R15];
